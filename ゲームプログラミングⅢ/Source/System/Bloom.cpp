...
bloom::bloom(ID3D11Device* device, uint32_t width, uint32_t height)
{
	...
	GpuResourceUtils::LoadPixelShader(device, "Data/Shader/glow_extraction_ps.cso", glow_extraction_ps.GetAddressOf());
	GpuResourceUtils::LoadPixelShader(device, "Data/Shader/gaussian_blur_downsampling_ps.cso", gaussian_blur_downsampling_ps.GetAddressOf());
	GpuResourceUtils::LoadPixelShader(device, "Data/Shader/gaussian_blur_horizontal_ps.cso", gaussian_blur_horizontal_ps.GetAddressOf());
	GpuResourceUtils::LoadPixelShader(device, "Data/Shader/gaussian_blur_vertical_ps.cso", gaussian_blur_vertical_ps.GetAddressOf());
	GpuResourceUtils::LoadPixelShader(device, "Data/Shader/gaussian_blur_upsampling_ps.cso", gaussian_blur_upsampling_ps.GetAddressOf());
...
void bloom::make(ID3D11DeviceContext* immediate_context, ID3D11ShaderResourceView* color_map)
{
	...
	immediate_context->PSSetConstantBuffers(12, 1, constant_buffer.GetAddressOf());
