...
CustomShader::CustomShader(ID3D11Device* device)
{
	// 頂点シェーダー
	GpuResourceUtils::LoadVertexShader(
		device,
		"Data/Shader/CustomVS.cso",
...
// 開始処理
void CustomShader::Begin(const RenderContext& rc)
{
...
// 更新処理
void CustomShader::Update(const RenderContext& rc, const ModelResource::Material& material)
{
	ID3D11DeviceContext* dc = rc.deviceContext;
...
// 描画終了
void CustomShader::End(const RenderContext& rc)
{
	ID3D11DeviceContext* dc = rc.deviceContext;
